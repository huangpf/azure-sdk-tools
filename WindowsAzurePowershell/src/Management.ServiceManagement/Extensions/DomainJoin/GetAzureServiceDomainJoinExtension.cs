...
namespace Microsoft.WindowsAzure.Management.ServiceManagement.Extensions
{
    ...
    /// <summary>
    /// Get Windows Azure Service Domain Join Extension.
    /// </summary>
    [Cmdlet(VerbsCommon.Get, DomainJoinExtensionNoun), OutputType(typeof(IEnumerable<RemoteDesktopExtensionContext>))]
    public class GetAzureServiceDomainJoinExtensionCommand : BaseAzureServiceDomainJoinExtensionCmdlet
    {
        public GetAzureServiceDomainJoinExtensionCommand()
            : base()
        {
        }

        public GetAzureServiceDomainJoinExtensionCommand(IServiceManagement channel)
            : base(channel)
        {
        }
        ...
        public void ExecuteCommand()
        {
            ...
            ExecuteClientActionInOCS(null,
                ...
                (op, extensions) =>
                {
                    var roleList = (from r in Deployment.RoleList
                    ...
                    return from role in roleList
                           ...
                           select GetContext(op, role, extension) as DomainJoinExtensionContext;
                });
        }
