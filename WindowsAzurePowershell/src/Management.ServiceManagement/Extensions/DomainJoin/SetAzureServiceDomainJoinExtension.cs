...
namespace Microsoft.WindowsAzure.Management.ServiceManagement.Extensions
{
    ...
    /// <summary>
    /// Set Windows Azure Service Domain Join Extension.
    /// </summary>
    [Cmdlet(VerbsCommon.Set, DomainJoinExtensionNoun, DefaultParameterSetName = DomainParameterSet), OutputType(typeof(ManagementOperationContext))]
    public class SetAzureServiceDomainJoinExtensionCommand : BaseAzureServiceDomainJoinExtensionCmdlet
    {
        public SetAzureServiceDomainJoinExtensionCommand()
            : base()
        {
        }

        public SetAzureServiceDomainJoinExtensionCommand(IServiceManagement channel)
            : base(channel)
        {
        }
